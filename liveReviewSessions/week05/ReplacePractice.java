...
public class ReplacePractice {
    public static void main(String[] args) {
        ...
        String word="gitbub";
        System.out.println(word.replace("hub","lab"));//actually an object is created but not assigned to a reference(so we an unreferenced object) Garbage collector cleans that object //JAVA Memeory Usage Topic
